                                            ...
                                            <div className="grid grid-cols-12 grid-rows-3 md:grid-rows-4 grid-flow-row gap-8">
                                                ...
                                                <div className="col-span-12 md:col-span-8 row-span-1 md:row-span-1">
                                                    ...
                                                    <p className="mb-2 flex items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mr-2" viewBox="0 0 512 512">
                                                        ...
                                                        <a href="https://twitter.com/RevinaScarlet">Twitter</a>
                                                    </p>
                                                    <p className="mb-2 flex items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mr-2" viewBox="0 0 320 512">
                                                            <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"/>
                                                        </svg>
                                                        <a href="https://www.facebook.com/Revina-ScarletMirai-Dream-ID-102504732064587/">Facebook</a>
                                                    </p>
                                                    <p className="mb-2 flex items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mr-2" viewBox="0 0 448 512">
                                                        ...
                                                        <a href="https://www.instagram.com/revinascarlet/">Instagram</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="grid grid-cols-12 grid-rows-3 md:grid-rows-4 grid-flow-row gap-8">
                                                ...
                                                <div className="col-span-12 md:col-span-8 row-span-1 md:row-span-1">
                                                    ...
                                                    <p className="mb-2 flex items-center">
                                                        ...
                                                        <a href="https://twitter.com/yuukiyozora1111">Twitter</a>
                                                    </p>
                                                    <p className="mb-2 flex items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mr-2" viewBox="0 0 320 512">
                                                            <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"/>
                                                        </svg>
                                                        <a href="https://www.facebook.com/Yuuki-YozoraMirai-Dream-ID-102359888747725/">Facebook</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
