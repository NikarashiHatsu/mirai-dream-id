export default function StaffCard({className = '', image, name, role, facebook = '#', twitter = '#', youtube = '#', instagram = '#'}) {
    ...
    return (
        <div className={ fixedClassName }>
            ...
            <div className="flex justify-center h-4">
                ...
                <a className={youtube != '#' ? 'block w-6' : 'hidden'} target="_blank" href={youtube}>
                ...
                <a className={instagram != '#' ? 'block w-6' : 'hidden'} target="_blank" href={instagram}>
