    ...
    render() {
        return (
            <>
                ...
                <div className="relative flex items-center w-full h-screen pt-8 text-white bg-gradient-to-br from-purple-800 to-purple-700">
                    ...
                    <div className="absolute right-0 w-full h-8 bg-yellow-200 -bottom-4 transform-gpu -skew-y-1"></div>
                    <div className="absolute right-0 w-full h-8 bg-yellow-300 -bottom-8 transform-gpu -skew-y-2"></div>
                </div>
            </>
        )
    }
