...
//                     </div>
//                     <div className="static top-0 z-10 flex flex-col w-full mx-auto max-w-7xl items-center">
//                         <h3 className="mb-4 text-3xl">Audisi telah selesai! Sampai jumpa di audisi selanjutnya!</h3>
//                     </div>
//                 </div>
//             </div>
...
export default function Audition() {
    ...
    // Gen 2
    const dateBeforeAudition = Date.parse("April 5, 2022. 06:00")
    const dateAfterAudition = Date.parse("April 23, 2022. 23:59")
